...
RSTUDIO_ICON_PATH = osp.join(IMAGE_PATH, 'rstudio-icon.png')
...
# -----------------------------------------------------------------------------
CONDA_MANAGER_INSTALLED = osp.join(
    IMAGE_PATH, 'icons', 'check-box-checked-active.svg'
)
CONDA_MANAGER_NOT_INSTALLED = osp.join(
    IMAGE_PATH, 'icons', 'check-box-blank.svg'
)
...
CONDA_MANAGER_UPGRADE_ARROW = osp.join(
    IMAGE_PATH, 'icons', 'update-app-active.svg'
)
...
CONDA_MANAGER_SEARCH = osp.join(
    IMAGE_PATH, 'conda-manager-magnifying-glass.svg'
)
