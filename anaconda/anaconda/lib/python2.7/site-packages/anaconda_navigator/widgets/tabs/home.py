...
class HomeTab(WidgetBase):
    ...
    sig_environment_updated = Signal()
    ...
    def __init__(self, parent=None):
        ...
        self.first_widget = self.combo_environments
        ...
        self.list_applications.sig_url_clicked.connect(self.sig_url_clicked)
    ...
    def _environment_updated(self, index):
        ...
        if prefix:
            self.sig_environment_changed.emit(
                selected_env, prefix, C.HOME_APPLICATION
            )
    ...
    def set_environments(self, prefix=None):
        ...
        if prefix is None:
            prefix = os.environ.get('CONDA_PREFIX', self.api.ROOT_PREFIX)
    ...
    def setup_tab(self, apps=None, prefix=None):
        ...
        self.sig_environment_updated.emit()
    ...
    def last_widget(self):
        if self.list_applications.items():
            return self.list_applications.items()[-1].widget
    ...
    def current_environment(self):
        ...
        env_name = self.combo_environments.currentText()
    ...
    def ordered_widgets(self, next_widget=None):
        ...
        ordered_widgets = [
            self.combo_environments,
            self.button_channels,
            self.button_refresh,
        ]
        ordered_widgets += self.list_applications.ordered_widgets()
